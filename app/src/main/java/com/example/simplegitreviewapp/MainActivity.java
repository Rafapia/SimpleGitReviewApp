...
public class MainActivity extends AppCompatActivity {
    ...
    // Create flashcards.
    ArrayList<Flashcard> gitTerms = new ArrayList<Flashcard>();
...
//        intent.putExtra(MAIN_ACTIVITY_MESSAGE, gitTerms);
    ...
    private void populateGitTerms(ArrayList<Flashcard> flashcards) {

        flashcards.add(new Flashcard("Blame",
        ...
        flashcards.add(new Flashcard("Branch",
        ...
        flashcards.add(new Flashcard("Clone",
                "A clone is a copy of a repository that lives on your computer instead " +
                        ...
                        " when you're online."));
        flashcards.add(new Flashcard("Collaborator",
        ...
        flashcards.add(new Flashcard("Commit",
        ...
        flashcards.add(new Flashcard("Diff",
        ...
        flashcards.add(new Flashcard("Fetch",
                "Fetching refers to getting the latest changes from an online " +
                        ...
                        "local machine)."));
        flashcards.add(new Flashcard("Fork",
                "A fork is a personal copy of another user's repository that lives on " +
                        ...
                        "from the original."));
        flashcards.add(new Flashcard("Issue",
        ...
        flashcards.add(new Flashcard("Merge",
        ...
        flashcards.add(new Flashcard("Private Repository",
        ...
        flashcards.add(new Flashcard("Pull",
                "Pull refers to when you are fetching in changes and merging them. For" +
                        ...
                        "up to date."));
        flashcards.add(new Flashcard("Pull Request",
        ...
        flashcards.add(new Flashcard("Repository",
